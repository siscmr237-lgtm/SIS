...
/**
 * THE MARKETING PAGE, PARKED AT /home.
 *
 * It was the site root until the root was given back to the school door: '/'
 * now sends a visitor with no session to /school/signup, which is where the
 * product wants somebody who has not signed up yet. This page is kept whole,
 * and still served, at a URL of its own rather than deleted, because what to do
 * with it is an open question and not one to answer by losing the file. Nothing
 * links to it -- reaching it means typing the address.
 *
