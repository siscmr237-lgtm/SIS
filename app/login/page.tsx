...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {/* Centered card: split panel on desktop, single column on mobile */}
      <div
      ...
      >
        ...
        <div
          ...
          style={{ width: "55%", backgroundColor: "#dbeafe", padding: "3rem" }}
        >
          <img
        ...
        >
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div className="text-center text-sm" style={{ color: "#6B7280" }}>
              ...
              <a href="/signup" className="font-medium" style={{ color: "#007BFF" }}>
                Sign up
              </a>
            </div>
          </form>
